          ...
          <div class="px-3 sm:px-4 mb-3 flex">
            <div class="w-full">
              ...
              <div v-else>
                ...
                <button v-else @click="sendComment()" class="w-full py-2 px-4 text-base font-medium rounded-md text-white transition ease-in-out bg-indigo-600 hover:bg-indigo-500 dark:hover:bg-indigo-700 focus:outline-none">Відправитиь</button>
              </div>
            </div>
          </div>
        </div>
